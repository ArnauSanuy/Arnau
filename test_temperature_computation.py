...
def P_compton():
    """TODO: implement Compton Power formula"""
    pass


def P_bremms():
    """TODO: implement Bremms Power formula"""
    pass
...
T_e = np.logspace(8, 10, 200) * u.K
theta_e = theta_from_T(T_e)
m_dot_values = np.logspace(-8, 0, 20)
...
for _m_dot in m_dot_values:
    ...
    equilibrium = np.abs(Q_e_plus_values - P_synch_values)
